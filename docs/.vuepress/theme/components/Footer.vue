 ...
 * @LastEditTime: 2021-05-18 20:45:57
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \blog2\docs\.vuepress\theme\components\Footer.vue
-->
<template>
  <div class="footer-wrapper">
    <span>
      <i class="iconfont reco-theme"></i>
      <a target="blank" href="https://github.com/tangsanshao7">
        Powered by
        <a href="https://github.com/tangsanshao7"><b>tangsanshao</b></a>
      </a>
    </span>
